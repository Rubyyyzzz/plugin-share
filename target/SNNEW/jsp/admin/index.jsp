...
<html lang="en">
  <head>
    ...
    <link href="<%=basePath %>jsp/admin/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.css" rel="stylesheet" type="text/css" media="screen"/>
    <link rel="stylesheet" href="<%=basePath %>jsp/admin/css/owl.carousel.css" type="text/css">
  ...
  <section id="container" >
      ...
      <jsp:include page="include/sidebar.jsp" flush="true">
          <jsp:param name="sub-menu-name" value="index" />
      </jsp:include>
      <!--sidebar end-->
      <!--main content start-->
                      ...
                      <section class="panel">
                          <div class="panel-body">
                              <a href="#" class="task-thumb">
                                  <img src="<%=basePath%>jsp/admin/img/avatar1.jpg" alt="">
                              </a>
                                          ...
                                          <div class="timeline-desk">
                                              <div class="panel">
                                                  <div class="panel-body">
                                                      ...
                                                      <div class="album">
                                                          <a href="#">
                                                              <img alt="" src="<%=basePath %>jsp/admin/img/sm-img-1.jpg">
                                                          </a>
                                                          <a href="#">
                                                              <img alt="" src="<%=basePath %>jsp/admin/img/sm-img-2.jpg">
                                                          </a>
                                                          <a href="#">
                                                              <img alt="" src="<%=basePath %>jsp/admin/img/sm-img-3.jpg">
                                                          </a>
                                                          <a href="#">
                                                              <img alt="" src="<%=basePath %>jsp/admin/img/sm-img-1.jpg">
                                                          </a>
                      ...
                      <section class="panel post-wrap pro-box">
                          ...
                          <aside class="post-highlight yellow v-align">
                              <div class="panel-body text-center">
                                  <div class="pro-thumb">
                                      <img src="<%=basePath%>jsp/admin/img/ring.jpg" alt="">
                                  </div>
                              </div>
                          </aside>
                      </section>
                                  ...
                                  <div class="follower">
                                      <div class="panel-body">
                                          ...
                                          <div class="follow-ava">
                                              <img src="<%=basePath %>jsp/admin/img/follower-avatar.jpg" alt="">
                                          </div>
                                      </div>
                                  </div>
    ...
    <script src="<%=basePath %>jsp/admin/js/jquery-1.8.3.min.js"></script>
    ...
    <script src="<%=basePath %>jsp/admin/js/jquery.sparkline.js" type="text/javascript"></script>
    <script src="<%=basePath %>jsp/admin/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.js"></script>
    <script src="<%=basePath %>jsp/admin/js/owl.carousel.js" ></script>
    <script src="<%=basePath %>jsp/admin/js/jquery.customSelect.min.js" ></script>
    <script src="<%=basePath %>jsp/admin/js/respond.min.js" ></script>
    ...
    <script src="<%=basePath %>jsp/admin/js/sparkline-chart.js"></script>
    <script src="<%=basePath %>jsp/admin/js/easy-pie-chart.js"></script>
    <script src="<%=basePath %>jsp/admin/js/count.js"></script>
