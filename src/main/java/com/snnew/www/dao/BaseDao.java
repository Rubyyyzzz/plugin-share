...
public class BaseDao<T, ID extends Serializable> implements IBaseDao<T, ID> {
     ...
     * <完整保存实体>
     * @param t 实体参数
     * @see com.exam.dao.IBaseDao#save(Object)
     */
    @Override
     ...
     * <保存或者更新实体>
     * @param t 实体
     * @see com.exam.dao.IBaseDao#saveOrUpdate(Object)
     */
    @Override
     ...
     * @param id 实体的id
     * @return 查询出来的实体
     * @see com.exam.dao.IBaseDao#load(Serializable)
     */
    @Override
    public T load(ID id) {
     ...
     * @param id 实体的id
     * @return 查询出来的实体
     * @see com.exam.dao.IBaseDao#get(Serializable)
     */
    @Override
    public T get(ID id) {
     ...
     * @param t 实体
     * @return 是否包含
     * @see com.exam.dao.IBaseDao#contains(Object)
     */
    @Override
     ...
     * <删除表中的t数据>
     * @param t 实体
     * @see com.exam.dao.IBaseDao#delete(Object)
     */
    @Override
     ...
     * @param Id 实体id
     * @return 是否删除成功
     * @see com.exam.dao.IBaseDao#deleteById(Serializable)
     */
    @Override
     ...
     * @see com.exam.dao.IBaseDao#deleteAll(Collection)
     */
    @Override
     ...
     * @param hqlString hql
     * @param values 不定参数数组
     * @see com.exam.dao.IBaseDao#queryHql(String, Object[])
     */
    @Override
     ...
     * @param sqlString sql
     * @param values 不定参数数组
     * @see com.exam.dao.IBaseDao#querySql(String, Object[])
     */
    @Override
     ...
     * @return 查询实体
     * @see com.exam.dao.IBaseDao#getByHQL(String, Object[])
     */
    @Override
     ...
     * @param values 不定参数的Object数组
     * @return 查询实体
     * @see com.exam.dao.IBaseDao#getBySQL(String, Object[])
     */
    @Override
     ...
     * @see com.exam.dao.IBaseDao#getListByHQL(String, Object[])
     */
    @Override
     ...
     * @param values 不定参数的Object数组
     * @return 查询多个实体的List集合
     * @see com.exam.dao.IBaseDao#getListBySQL(String, Object[])
     */
    @Override
     ...
     * @param values
     * @return List
     * @see com.exam.dao.IBaseDao#findListBySql(String, com.exam.dao.RowMapper, Object[])
     */
    @Override
     ...
     * <refresh>
     * @param t 实体
     * @see com.exam.dao.IBaseDao#refresh(Object)
     */
    @Override
     ...
     * <update>
     * @param t 实体
     * @see com.exam.dao.IBaseDao#update(Object)
     */
    @Override
     ...
     * @param values 不定参数的Object数组
     * @return 记录总数
     * @see com.exam.dao.IBaseDao#countByHql(String, Object[])
     */
    @Override
     ...
     * @see com.exam.dao.IBaseDao#findPageByFetchedHql(String, String, int, int, Object[])
     */
    @Override
